...
function formatDataTable (elem, walk, builder, formatOptions) {
  ...
  builder.closeTable({
    ...
    leadingLineBreaks: formatOptions.leadingLineBreaks !== undefined ? formatOptions.leadingLineBreaks : 0,
    trailingLineBreaks: formatOptions.trailingLineBreaks !== undefined ? formatOptions.trailingLineBreaks : 0    
  });
